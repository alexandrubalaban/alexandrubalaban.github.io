        ...
        <div class="row">
            <div class="col-md-4 list-group">
                <ul class="profile-menu">
                    <a  href="{{ url('user/edit/profile', Auth::user()->id) }}" class="list-group-item active">Edit profile</a>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST" action="{{ url('user/edit/profile', Auth::user()->id) }}">
